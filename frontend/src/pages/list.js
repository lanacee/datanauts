...
const columns = [
  StringColumn({
    title: "Movie Title",
    mapDataToValue: (data) => data.title,
  }),
  StringColumn({
    title: "Lorem Ipsum Description",
    maxWidth: 300,
    lineClamp: 3,
    mapDataToValue: (data) => data.loremIpsum,
  }),
  CategoricalColumn({
    title: "Genre",
  ...
  NumericalColumn({
    ...
    mapDataToValue: (data) => data.budget,
  }),
  NumericalColumn({
    title: "Box Office (millions)",
    format: NUMERICAL_FORMATS.ACCOUNTING,
    mapDataToValue: (data) => data.boxOffice,
  }),
  NumericalColumn({
    title: "ROI",
    precision: 2,
    mapDataToValue: (data) => data.roi,
  }),
  NumericalColumn({
    title: "Rating IMDB",
    precision: 2,
    mapDataToValue: (data) => data.imdb,
  }),
];
const rows = [
  {
